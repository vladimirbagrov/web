...
class Flyweight
{
    ...
    public function operation($uniqueState): void
    {
        ...
        echo "Минимальный вес: отображение общего ($s) и уникального ($u) состояния.\n";
    }
}
...
class FlyweightFactory
{
    ...
    public function getFlyweight(array $sharedState): Flyweight
    {
        ...
        if (!isset($this->flyweights[$key])) {
            echo "FlyweightFactory: Не удается найти flyweight, создаю новый.\n";
            $this->flyweights[$key] = new Flyweight($sharedState);
        } else {
            echo "FlyweightFactory: Повторное использование существующего веса. \n";
        }
