...
class Subject implements \SplSubject
{
    ...
    {
        echo "Тема: Прикреплен наблюдатель.\n";
    ...
    public function detach(\SplObserver $observer): void
    {
        ...
        echo "Тема: Отстраненный наблюдатель.\n";
    }
    ...
    {
        echo "\nТема: Я делаю что-то важное.\n";
        $this->state = rand(0, 10);

        echo "Тема: Мое состояние только что изменилось на: {$this->state}\n";
        $this->notify();
    }
}
...
class ConcreteObserverA implements \SplObserver
{
    ...
    {
        if ($subject->state < 3) {
            echo "Конкретный наблюдатель: Отреагировал на событие.\n";
        }
    }
}
