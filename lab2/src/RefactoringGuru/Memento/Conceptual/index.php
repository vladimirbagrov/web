...
class Originator
{
    ...
    {
        $this->state = $state;
        echo "Создатель: Мое начальное состояние таково: {$this->state}\n";
    }
...
class Caretaker
{
    ...
    {
        echo "\nХранитель: Сохранение состояния Создателя...\n";
    ...
    public function undo(): void
    {
        ...
        echo "Смотритель: Восстановление состояния до: " . $memento->getName() . "\n";
        try {
    ...
    {
        echo "Смотритель: Вот список сувениров:\n";
...
echo "\nКлиент: Теперь давайте сделаем откат!\n\n";
$caretaker->undo();
